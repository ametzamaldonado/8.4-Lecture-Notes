...
const createBookmark = async (bookmark) => {
  ...
  try {
    const newBookmark = await db.one(
      ...
      // RETURNING * <--- tells the database to return the successful entry of our new bookmark, along with the original values.
...
// we will have a bunch of exports, hence the object to export them all.
module.exports = {
  getAllBookmarks,
  getBookmark,
  createBookmark,
